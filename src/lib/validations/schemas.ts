 ...
 */
import { z } from "zod";
import { REGEX_PATTERNS, PERSON_TYPE, PRODUCT_STATUS, ORDER_STATUS } from "../constants";
...
export const productSchema = z.object({
  ...
  status: z.enum([PRODUCT_STATUS.AVAILABLE, PRODUCT_STATUS.UNAVAILABLE]).default(PRODUCT_STATUS.AVAILABLE),
});
...
export const updateOrderStatusSchema = z.object({
  status: z.enum([ORDER_STATUS.PENDING, ORDER_STATUS.IN_PROGRESS, ORDER_STATUS.PLANTED]),
});

// Schema de Query de Paginação
